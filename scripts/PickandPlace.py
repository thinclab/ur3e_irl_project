...
#        while diff:
    ...
    def view(self, tol=0.001, goal_tol=0.001, orientation_tol=0.001):
        ...
        view_joint_angles = [-0.8515051046954554, -2.2179604969420375, -1.3198388814926147, -2.756951948205465, 2.5211257934570312, 0.022068094462156296]
        #[-0.6475113073932093, -1.9155713520445765, -1.4149178266525269, -3.124627252618307, 2.7653942108154297, 0.014964444562792778]
